          ...
          <div className="col-md-4">
            <div className="card h-100 shadow-sm border-0 card-hover">
              <div className="card-body text-center d-flex flex-column justify-content-center">
                ...
                <Link to="/mi-tienda" className="btn mt-3" style={{ backgroundColor: "var(--color-primario)", color: "white" }}>
                  Datos Generales
                </Link>
              </div>
            </div>
          ...
          <div className="col-md-4">
            <div className="card h-100 shadow-sm border-0 card-hover">
              <div className="card-body text-center d-flex flex-column justify-content-center">
                ...
                <Link to="/productos" className="btn mt-3" style={{ backgroundColor: "var(--color-primario)", color: "white" }}>
                  Ver Productos
                </Link>
              </div>
            </div>
